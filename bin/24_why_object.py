...
2. Abstraction: Keeping Methods inside object idea is to provide abstraction
                which means end user of that class should know how to use
                those methods, NO NEED TO KNOW HOW EACH METHOD IS IMPLEMENTED
"""

print("DATA: Inside object, we are keeping data")
print("-"*20)
# ---------------
...
print("METHODS present inside object")
print("-"*20)
# ---------------
